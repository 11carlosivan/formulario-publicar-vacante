...

    {
...

      {
...

        {
          ...
          $estado_string = "Marcar como publicada";
...
<html lang="es">
  ...
  <body>
    ...
    <header>
      ...
      <div class="logout-container">
        ...
        <button id="btn_compartir_enlaces" class="logout-button">Compartir enlaces</button>

        <button id="btn_close_sesion" class="logout-button">Cerrar sesión</button>
  ...
  <div class="buttons">
    ...
    <button id="btn_copiar_codigo" class="btn">Copiar Código</button>

    

    <button id="btn_cambiar_estado" data-vacante-id="<?php echo $id; ?>" class="btn"><?php echo $estado_string; ?>

    </button>



    <button id="btn_eliminar_vacante" data-vacante-id="<?php echo $id; ?>" class="btn btn-delete">

      Eliminar

    </button>

    <button id="btn_bloquear_ip" data-vacante-ip="<?php echo $id; ?>" class="btn btn-delete">
...
<div class="c-btn">
  ...
  <button id="btn_delete_confirm" class="btn btn-delete" data-vacante-id="<?php echo $id; ?>">
